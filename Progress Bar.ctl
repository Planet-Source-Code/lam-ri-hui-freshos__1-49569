...
Begin VB.UserControl PB_Blue 
   ...
   End
End
Attribute VB_Name = "PB_Blue"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = True
Attribute VB_PredeclaredId = False
Attribute VB_Exposed = False
'Blue Gradient Progress Bar - A Progress Bar with blue gradient
'Code(C)Lam Ri Hui (rihui@email.com)
'Version year 2003
'This is a progress bar with blue gradient.
